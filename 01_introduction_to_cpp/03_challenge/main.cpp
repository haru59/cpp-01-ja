//# チャレンジ3
//次のコードをコピーして新しい `main.cpp` ファイルに貼り付けます。コード内のコメントに書かれた指示に沿ってタスクを完了します。
...
int main() {
    ...
    char aLetter = 'k'; //クオートがシングル
    std::string aWord = "kaleidescope"; //文字列はダブルクオート
    ...
    const int d = 1; // ここに定数変数1を記述 const = コンスト、 初期化時は｛｝ｊに利点有り
    const float e=1.2345; // ここに定数変数2を記述　
    const double f=3.14159265358979; // ここに定数変数3を記述
